<template>
  <div id="octagon" class="row">
    <div class="col s12 m8 offset-m2">
      <img class="responsive-img center-block" src="https://www.f3images.com/IMD/MD_images/Calculators/Sand_Calculator_Images/Sand_octagon.jpg">
      ...
      <p class="center-align" v-if="firstNumber===''||secondNumber===''||thirdNumber===''||forthNumber===''||fifthNumber===''">Please enter a Length, Width, Height &amp; Front Pane.</p>
